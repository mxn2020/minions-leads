...
/**
 * @minions-leads/cli — CLI for Minions Leads
 *
...
import { customTypes } from '@minions-leads/sdk';
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Leads'));
        console.log(chalk.dim('Lead records, company profiles, contact details, and qualification status'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-leads/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-leads/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions-leads')}`);
